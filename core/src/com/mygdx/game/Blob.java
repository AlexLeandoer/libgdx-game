...
/**
 * Created by alexh on 01/02/2018.
 */
...
public class Blob extends Image{
    ...
    public Blob() {
        ...
        final float swidth = 80;
        final float sheight = 80;
        this.setSize(1, height / width);

        Texture blobTexture = new Texture("blobwalk.png");
        TextureRegion[][] grid = TextureRegion.split(blobTexture, (int) width, (int) height);

        /*Texture standAnimation = new Texture("blobidle.png");
        ...
        */
        walk = new Animation(0.15f, grid[0][1], grid[0][2], grid[0][3], grid[0][4], grid[0][5], grid[0][6]);
